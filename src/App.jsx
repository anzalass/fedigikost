...
function App() {
  ...
  return (
    <>
      <BrowserRouter>
        <Routes>
          <Route path="/login" element={<LoginPage userSession={dataCookie} loadingValue={loading} />} />
          <Route path="/" Component={() => <HomePage userSession={dataCookie} />} />
          <Route path="/tambah-barang" Component={() => <PengadaanBarang userSession={dataCookie} />} />
          <Route path="/detail-ruangan/:id" Component={() => <DetailBarangRuangan userSession={dataCookie} />} />
          <Route path="/data-ruangan" element={<DataRuanganPage userSession={dataCookie} />} />
          <Route path="/pengeluaran" element={<PengeluaranPage userSession={dataCookie} />} />
          {/* Owner Routes */}
