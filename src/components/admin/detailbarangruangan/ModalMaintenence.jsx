...
export default function ModalMaintenence({ open, setOpen, data,ruang}) {
  ...
  const tambahPemeliharaan = async()=>{
    try{
      const tambah = await axios.post("http://127.0.0.1:8000/api/tambahPemeliharaan",dataBarang);
        ...
        <div className="w-[90%] mx-auto mt-3 my-auto">
          <div className="w-full">
            ...
            <div className="mx-auto flex justify-center items-center w-full mt-2">
              <button onClick={tambahPemeliharaan} className="bg-[#7B2CBF] px-3 py-1 w-[140px] rounded-md text-[#E5D5F2] font-abc">
                Simpan
              </button>
              <button
