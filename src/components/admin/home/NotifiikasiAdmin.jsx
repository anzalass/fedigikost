...
export default function NotifiikasiAdmin() {
  return (
      ...
      <div className="mt-4">
        <div className="flex w-full mb-2">
          ...
          <div className="w-[70%] ml-4">
            <h1 className="font-abc">Pengajuan Barang</h1>
            <h3 className="font-abc text-[13px] italic">Unggul Prayuda</h3>
            <p className="font-abc text-[13px] text-sky-600">20 Agustus 2023</p>
          </div>
        </div>
        <div className="flex w-full mb-2">
          <div className="w-[20%] mt-3 ">
        ...
        <div className="flex w-full mb-2">
          ...
          <div className="w-[70%] ml-4">
            <h1 className="font-abc">Pengajuan Barang</h1>
            <h3 className="font-abc text-[13px] italic">Unggul Prayuda</h3>
            <p className="font-abc text-[13px] text-sky-600">27 Agustus 2023</p>
          </div>
        </div>
      </div>
    </div>
